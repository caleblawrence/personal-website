...
export const meta = {
  published: true,
  publishedAt: 'December 29, 2019',
  title: 'Welcome to my blog/website',
  summary: 'Some reasons for why I created this website and what I might write about',
}
...
I've been wanting to make a personal website for a while now and I also wanted to learn Next.js so here we are. I'm going to write another post about why I chose Next.js and my experience so far so I won't go into it here. I think writing is a lot of fun and I used to blog a long time ago so that's one of the main reasons for this website. Hopefully, I'll be able to write somewhat consistently.
